    ...
    const fetchData = async () => {
      try {
        ...
        const requests = [
          ...
          axios.get(`${API_BASE_URL}/orders?limit=1000`, {
            headers: { Authorization: `Bearer ${token}` },
          }),
          ...
          axios.get(`${API_BASE_URL}/table-reservations`, {
            headers: { Authorization: `Bearer ${token}` },
          }).catch(() => ({ data: [] })),
          // Tables data
        ...
        axios.get(`${API_BASE_URL}/food-recommendations/evaluation/system?testPeriodDays=7`, {
          headers: { Authorization: `Bearer ${token}` },
